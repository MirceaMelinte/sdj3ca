...
public interface IDataServer extends Remote {
	...
	CarList executeGetCars() throws RemoteException, SQLException;
	
	PalletList executeGetPallets() throws RemoteException, SQLException;
	
	ProductList executeGetProducts() throws RemoteException, SQLException;
