...
public class SkeletonSingleton implements ICarServiceSkeletonInterface
{
   ...
   {  
      ...
      Serialization<Car> serCar = new Serialization<>(); // Create serialization object of type Car
      Serialization<PartList> serPartList = new Serialization<>(); // Create serialization object of type PartList
      
      try
      {
         Car car = serCar.createObjectFromXMLString(xmlCar); // Create car object from XML string      
