...
/**
 *  TraceStolenCar bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class TraceStolenCar implements org.apache.axis2.databinding.ADBBean {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"traceStolenCar".equals(type)) {
                            ...
                            return (TraceStolenCar) webservice.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
