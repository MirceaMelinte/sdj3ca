...
/**
 *  TraceStolenPallets bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class TraceStolenPallets implements org.apache.axis2.databinding.ADBBean {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"traceStolenPallets".equals(type)) {
                            ...
                            return (TraceStolenPallets) webservice.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
